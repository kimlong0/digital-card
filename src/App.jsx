    ...
    <div className="App">
      <div className="main-container">
        <div className='logo-container'>
            <img src="./src/assets/pfp.png" className="logo" alt="profile picture" />
        </div>
        <div className='description-container'>
          ...
          <div className="buttons">
            ...
            <button className='contact-button email'><img src="./src/assets/Mail.svg"/>Email</button>
            </a>
            <a className='contact-link' href='https://www.linkedin.com/in/kimlong-nguyen/' target="_blank">
              <button className='contact-button linkedin'><img src="./src/assets/linkedin.svg"/>Linkedin</button>
            </a>
